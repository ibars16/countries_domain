...
use App\Repository\NaturalParkTouristGuideRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: NaturalParkTouristGuideRepository::class)]
class NaturalParkTouristGuide
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'naturalParkTouristGuides')]
